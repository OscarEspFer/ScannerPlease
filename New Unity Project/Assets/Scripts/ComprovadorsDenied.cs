...
public class ComprovadorsDenied : MonoBehaviour
{
    ...
    private bool comprovascaner(){
        if( scaner.GetComponent<UnityEngine.UI.Text>().text == "Xenófob" || scaner.GetComponent<UnityEngine.UI.Text>().text == "Elitista" || scaner.GetComponent<UnityEngine.UI.Text>().text == "Vengatiu" || scaner.GetComponent<UnityEngine.UI.Text>().text == "Codicios"){
            return false;
        }
        else{
            return true;
    ...
    private bool comprovaPCR(){
        if(PCR.GetComponent<UnityEngine.UI.Text>().text == "Malalt"){
            return false;
        }
        else{
            return true;
